            ...
            'items' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'บุคลากร', 'url' => ['/teachers'], 'visible' => Yii::$app->user->can('manageTeacher') ? TRUE : FALSE],
                        ...
                        ['label' => 'สรุปยอดคงเหลือ', 'url' => ['/materials/report'], 'visible' => Yii::$app->user->can('manageMaterial') ? TRUE : FALSE],
                    ],
